...
fn test_manual_layout() {
    ...
    let input_cap = place(make_murata_capacitor("GRT188R61H105KE13D"), 900, -150, Vertical);
    let v_reg = place(make_ti_tps_7b84_regulator("TPS7B8433QDCYRQ1"), 2300, 0, Horizontal);
    let output_cap = place(make_yageo_cc_series_cap("CC0805KKX5R8BB106"), 3500, -150, Vertical);
